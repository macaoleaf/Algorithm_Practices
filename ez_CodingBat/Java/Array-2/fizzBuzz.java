...
fizzBuzz(1, 6) ¡ú ["1", "2", "Fizz", "4", "Buzz"]
fizzBuzz(1, 8) ¡ú ["1", "2", "Fizz", "4", "Buzz", "Fizz", "7"]
fizzBuzz(1, 11) ¡ú ["1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz"]*/

public String[] fizzBuzz(int start, int end) {
  String[] result = new String[end - start];
  for(int n = start; n < end; n++){
    if(n % 3 == 0 && n % 5 == 0){
      result[n - start] = "FizzBuzz";
    }else if(n % 3 == 0){
      result[n - start] = "Fizz";
    }else if(n % 5 == 0){
      result[n - start] = "Buzz";
    }else{
      result[n - start] = String.valueOf(n);
    }
  }
  return result;
}